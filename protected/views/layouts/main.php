...
<body>
    <header class="header">
        ...
        <div class="header_midle">
            <div class="layout">
                <?php echo CHtml::link(CHtml::image($varBaseUrl . "/images/brand.png", 'Promosol', array('title' => 'Promosol')), $varBaseUrl, array('class' => 'logo')); ?>
            </div>
        </div>
        <div class="clear"></div>
    ...
    <footer class="footer">
        ...
        <div class="footer_bottom">
            <div class="layout">
                <p>Copyright &#169; <?php echo date('Y'); ?> Promosol. All rights reserved.</p>
                <ul>
