    ...
    <div class="span12">
        <div class="box box-color box-bordered">
            ...
            <div class="box-content nopadding">
                ...
                <div class="control-group">
                    <?php echo $form->labelEx($model, 'configurationFreeShippingOver', array('class' => 'control-label', 'for' => 'textfield')); ?>
                    <div class="controls">
                        <?php echo $form->textField($model, 'configurationFreeShippingOver',array('class' => 'input-xlarge', 'data-rule-required' => 'true',)); ?>
                        <?php echo $form->error($model, 'configurationFreeShippingOver'); ?>
                    </div>
                </div>  
